...
public class ForceRage implements Ability {
    ...
    public ForceRage(AbilityConfigManager configManager, ForcePlugin plugin) { this.configManager = configManager; this.plugin = plugin; }
    @Override public String getID() { return "FORCE_RAGE"; }
    @Override public String getName() { return "Force Rage"; }
    @Override public String getDescription() { return "Gain speed and damage, but become vulnerable."; }
    ...
    @Override public double getCooldown(int level) { return configManager.getDoubleValue(getID(), level, "cooldown", 35.0); }
    ...
    public void execute(Player player, ForceUser forceUser) {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                Location particleLoc1 = new Location(player.getWorld(), x1, playerLoc.getY() + (ticks % 20) / 10.0, z1);
